...
import { Search, Database, FileSpreadsheet, Settings as SettingsIcon, Play, LogOut } from 'lucide-react';
...
const Sidebar: React.FC = () => {
  ...
  const navItems = [
    { id: 'laboratory', label: 'Iniciar Búsqueda', icon: <Play size={20} />, path: '/laboratory' },
    { id: 'dashboard', label: 'Repositorio Público', icon: <Search size={20} />, path: '/dashboard' },
